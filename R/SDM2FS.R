#' @title 2-Span Slope Deflection Method(Fixed-Support)
#'
...
#' SDM2FS(3,2,"UDL","PL",20,40,1,1,1,1,1,1)
#' SDM2FS(3,2,"TDLE","PL",20,40,1,1,1,1,1,1)
#' SDM2FS(3,2,"TDLS","PL",20,40,1,1,1,1,1,1)
#'
#' Multiple load on a span(http://www.abzwater.com/sdm)
#' SDM2FS(3,2,"PL","PL",40,40,1,1,1,1,1,1)+ SDM2FF(3,2,"PL","PL",40,0,2,1,1,1,1,1)
#'
#' Framed  Structure(http://www.abzwater.com/sdm)
#' SDM2FS(5,10,"PL","UDL",0,5,1,1,1,1,1,1)
#'
#'
#'
#' @keywords Slope
